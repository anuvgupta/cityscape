...
- Rose `#b8616a` sky with a darker `#873a42` fog (220 → 500 units) — pushed back so the city stays clear and distant buildings read as silhouettes against the sky — **v0.12**
