...
- Window shader (`onBeforeCompile` on the building material) draws yellow (`#ffd84f`) rectangular windows on side faces only, aligned to a world-space 1.4×1.6 grid, with ~45% of cells "lit" via a hash and the bottom 1.5 units skipped so ground floors stay solid — **v0.34**
